...
public class BidManagerTest {
    ...
    /*
    public static class MyJMXDescriptor implements Descriptor   
    {  
        ...
        @Override
        public void exportTo(OutputStream out) throws DescriptorExportException, IllegalArgumentException {
            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        }
